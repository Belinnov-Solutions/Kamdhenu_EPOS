...
import LogoutButton from "../../feature-module/pages/login/LogoutButton";
const Header = () => {
  const { username, roleName } = useSelector((state) => state.user);
  ...
  useEffect(() => {
    // Remove sidebar classes on route change
