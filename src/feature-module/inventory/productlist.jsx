...
const ProductList = () => {
  ...
  const getProducts = async () => {
    ...
    try {
      ...
      // setError("Failed to load product list. Please try again later.");
    } finally {
      setLoading(false);
    }
  };
  ...
  useEffect(() => {
    // Only run getProducts once categories and brands are loaded
