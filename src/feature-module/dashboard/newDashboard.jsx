    ...
    const fetchTickets = async () => {
      try {
        const response = await axios.get(
          `${BASE_URL}api/v1/Order/GetTickets?storeId=${storeId}`
        );
      ...
      <div className="page-wrapper">
        <div className="content">
          <div className="alert alert-danger">
            Error loading ticket data: {error}
          </div>
        </div>
      </div>
    );
          ...
          <div className="col-xl-4 col-sm-6 col-12 d-flex">
            <div className="card bg-teal sale-widget flex-fill">
              <div className="card-body d-flex align-items-center">
                ...
                <div className="ms-2">
                  <p className="text-white mb-1">Tickets In Progress</p>
                  <div className="d-inline-flex align-items-center flex-wrap gap-2">
                    <h4 className="text-white">{inProgressTickets}</h4>
          ...
          <div className="col-xl-4 col-sm-6 col-12 d-flex">
            <div className="card bg-orange sale-widget flex-fill">
              <div className="card-body d-flex align-items-center">
                ...
                <div className="ms-2">
                  <p className="text-white mb-1">Pending Tickets</p>
                  <div className="d-inline-flex align-items-center flex-wrap gap-2">
                    <h4 className="text-white">{pendingTickets}</h4>
