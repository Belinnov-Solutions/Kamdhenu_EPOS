...
import TicketPrintDetails from "../feature-module/TicketPrint/TicketPrintDetails";
import ImportProduct from "../core/modals/inventory/ImportProduct";
export const publicRoutes = [
  ...
  {
    id: 99999,
    path: routes.ticketPrint,
    name: "home",
    element: <TicketPrintDetails />,
    route: Route,
  },
  ...
  {
    id: 9090, // Using a unique high number
    path: routes.importproduct,
    name: "ImportProduct",
